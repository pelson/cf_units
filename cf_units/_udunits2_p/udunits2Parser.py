...
def serializedATN():
    with StringIO() as buf:
        ...
        buf.write("\16\17\u0088\13\17\3\17\3\17\3\17\3\17\6\17\u008e\n\17")
        buf.write("\r\17\16\17\u008f\3\17\3\17\3\17\3\17\6\17\u0096\n\17")
        buf.write("\r\17\16\17\u0097\3\17\3\17\5\17\u009c\n\17\3\20\7\20")
...
class udunits2Parser ( Parser ):
    ...
    RULE_signed_int = 11
    RULE_any_int = 12
    RULE_juxtaposed_multiplication = 13
    RULE_divide = 14
    RULE_sign = 15
    ...
    ruleNames =  [ "unit_spec", "shift_spec", "multi_product", "product_spec", 
                   "div", "multi_power", "power_spec", "basic_spec", "basic_unit", 
                   "base_unit", "sci_number", "signed_int", "any_int", "juxtaposed_multiplication", 
                   "divide", "sign", "any_signed_number", "any_unsigned_number", 
                   "float_t", "timestamp", "signed_clock", "signed_hour_minute", 
                   "clock", "shift", "multiply", "exponent" ]
    ...
    class Shift_specContext(ParserRuleContext):
        ...
        def multi_product(self):
            return self.getTypedRuleContext(udunits2Parser.Multi_productContext,0)
    ...
    class Multi_productContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return udunits2Parser.RULE_multi_product

        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitMulti_product" ):
                return visitor.visitMulti_product(self)
            else:
                return visitor.visitChildren(self)
    ...
    def multi_product(self):
        ...
        localctx = udunits2Parser.Multi_productContext(self, self._ctx, self.state)
        self.enterRule(localctx, 4, self.RULE_multi_product)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 68
    ...
    class Product_specContext(ParserRuleContext):
        ...
        def multi_power(self):
            return self.getTypedRuleContext(udunits2Parser.Multi_powerContext,0)
    ...
    def product_spec(self):
        ...
        self.enterRule(localctx, 6, self.RULE_product_spec)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 88
            self._errHandler.sync(self)
    ...
    def div(self):
        ...
        self.enterRule(localctx, 8, self.RULE_div)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 90
            self.power_spec()
    ...
    def multi_power(self):
        ...
        self.enterRule(localctx, 10, self.RULE_multi_power)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 94
            self.power_spec()
    ...
    def power_spec(self):
        ...
        self.enterRule(localctx, 12, self.RULE_power_spec)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 98
            self._errHandler.sync(self)
    ...
    def basic_spec(self):
        ...
        self.enterRule(localctx, 14, self.RULE_basic_spec)
        try:
            self.state = 110
            self._errHandler.sync(self)
    ...
    def basic_unit(self):
        ...
        self.enterRule(localctx, 16, self.RULE_basic_unit)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 112
            self.base_unit()
    ...
    def base_unit(self):
        ...
        self.enterRule(localctx, 18, self.RULE_base_unit)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 114
    ...
    def sci_number(self):
        ...
        self.enterRule(localctx, 20, self.RULE_sci_number)
        self._la = 0 # Token type
        try:
            self.state = 122
            self._errHandler.sync(self)
    ...
    def any_int(self):
        ...
        self.enterRule(localctx, 24, self.RULE_any_int)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 126
    ...
    def juxtaposed_multiplication(self):
        ...
        self.enterRule(localctx, 26, self.RULE_juxtaposed_multiplication)
        self._la = 0 # Token type
        try:
            self.state = 153
            self._errHandler.sync(self)
    ...
    def divide(self):
        ...
        self.enterRule(localctx, 28, self.RULE_divide)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 158
